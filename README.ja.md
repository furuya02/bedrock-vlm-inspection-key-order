...
| 条件 | 変えたところ | A の検出/4 | C の検出/4 | 過検出/5 |
|---|---|---:|---:|---:|
| 前回のまま | — | 2 | 0 | 0 |
| キー順の入れ替え | スキーマの並びだけ。プロンプト本文は変更なし | 3 | 2 | 0 |
| 観測と判断の分離 | VLM に判定を出させない | 3 | 3 | 0 |

判断する側をルール・Claude Haiku 4.5・Jev の3つで差し替えて比べましたが、3つとも同じ 3/4 でした。
